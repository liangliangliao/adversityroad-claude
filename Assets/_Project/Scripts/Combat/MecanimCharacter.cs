...
namespace AdversityRoad.Combat
{
    ...
    public static class MecanimCharacter
    {
        ...
        /// 关键约束：必须与世界尺度一致——房间/导航网格/角色胶囊体(高2m)都按 ~2m
        /// 人形搭建；镜头预设(距离3.8~5.9m、注视高1.0~1.7)也按此取景。此前误调到 4.1m
        /// 时，巨大躯干会把镜头顶满（近身3.8m处只拍到肚子）→ 满屏白/看不见人。故收回到
        /// 偏英雄化但仍room-safe的 2.5m（略高于写实1.8m、脸部特征清晰、镜头取景正常）。</summary>
        public const float TargetHeight = 2.5f;
