...
namespace AdversityRoad.Core
{
    ...
    public class StoryManager : MonoBehaviour
    {
        ...
        public static readonly ActInfo[] Acts =
        {
            ...
            new ActInfo { title = "第五章 · 低谷与生存线（后续版本开放）",
        ...
        public static readonly ChapterInfo[] Chapters =
        {
            ...
            new ChapterInfo
            {
                ...
                victory = "责任天平终于回正。\n【边界与责任线 · 阶段完成】真正的负责不是什么都背，而是准确承担属于自己的那部分。\n（本线的「老实人消耗局」「无限代付走廊」子章将在后续版本开放。）\n\n最后的路通向一座安静的建筑：旧事回声馆。\n【终章 · 旧我与新我线】开启：不是杀死旧我，而是整合旧我。\n下一站：旧事回声馆（入口在拖延沼泽北侧，或「传送」面板直达）。"
            },
