...
namespace AdversityRoad.Core
{
    ...
    /// 序章·觉醒 → 公平与承诺线 → 外界刺激线 → 拖延与目标线 → 边界与责任线
    /// → 低谷与生存线 → 哲学与行动线 → 旧我与新我线（方案七大章节全部就位）。
    ...
    public class StoryManager : MonoBehaviour
    {
        ...
        public static readonly ActInfo[] Acts =
        {
            ...
            new ActInfo { title = "第六章 · 哲学与行动线",
                theme = "思想不是为了困住你，而是为了帮助你更清醒地行动。" },
            new ActInfo { title = "第七章 · 旧我与新我线",
                theme = "不是杀死旧我，而是整合旧我。" },
            new ActInfo { title = "第八章 · 羞耻与污名线",
        ...
        public static readonly ChapterInfo[] Chapters =
        {
            ...
            new ChapterInfo
            {
                ...
                victory = "巨像轰然散落成一地碎石，走廊的灯一盏盏亮起来。\n【低谷与生存线 · 完成】低谷不是身份，而是阶段——\n需要资源就去找，需要帮助就开口。\n\n生存稳住之后，另一种困境浮出水面：\n「读了这么多道理，为什么还是不知道怎么活？」\n【第六章 · 哲学与行动线】开启：思想是为了帮你更清醒地行动。\n下一站：哲学虚无图书馆（大厅东北的门）。"
            },

            // ================= 第六章 · 哲学与行动线 =================
            new ChapterInfo
            {
                actIndex = 6, zoneIndex = 19,
                enemyType = EnemyType.ConceptMazeMaster, enemyTier = EnemyTier.Chief,
                enemyId = "boss_concept_maze_master",
                title = "哲学线 其一 · 哲学虚无图书馆",
                intro = "昏黄的大图书馆：无穷的书架、落灰的阅读桌、\n漂在空气里的一句话——「读了这么多，还是不知道怎么活。」\n\n书架间的【概念迷宫师】被一层「引文护体」包裹，寻常刀剑几乎打不动：\n你引经据典，它比你更会引。\n\n破局关键：场中有**三座行动灯台**——走近点亮（「有些问题不是靠继续读解决的」），\n三座齐亮，引文护体当场崩碎。\n小心它的引文弹幕与概念迷环（红圈预警）。\n击败【首领·概念迷宫师】：想明白不是行动的前提。",
                victory = "护体崩碎的那一刻，书架间的雾也散了。\n书没有错——错的是拿「还没读懂」当「还不能开始」的借口。\n\n图书馆北门通向一座回声隆隆的大厅：\n每一个问题后面，都还有下一个问题。\n下一站：无限追问大厅。"
            },
            new ChapterInfo
            {
                actIndex = 6, zoneIndex = 20,
                enemyType = EnemyType.QuestionBeast, enemyTier = EnemyTier.Chief,
                enemyId = "boss_question_beast",
                title = "哲学线 其二 · 无限追问大厅",
                intro = "环形大厅的墙上挂满了门：\n「为什么偏偏是我？」「如果又失败了怎么办？」「人生到底有什么意义？」\n凑近**问题之门**只会陷入反刍——它们是诱饵，可以路过，不必推开。\n\n只有发亮的**行动之门**通向前方：穿过它恢复行动力、降低反刍（共 3 扇）。\n大厅深处的【无限问题兽】用问题弹幕连射，还会召来引文幽灵。\n击败【首领·无限问题兽】：问题可以带着走，路要先走起来。",
                victory = "问题兽瘫倒时，满墙的问题之门一扇扇安静下来。\n问题不需要全部回答——有些问题带着走，边走边答。\n\n大厅北门外，是一座悬在深渊之上的断桥。\n下一站：意志断桥。"
            },
            new ChapterInfo
            {
                actIndex = 6, zoneIndex = 21,
                enemyType = EnemyType.InfiniteAsker, enemyTier = EnemyTier.Chief,
                enemyId = "boss_infinite_asker",
                title = "哲学线 其三 · 意志断桥（终战）",
                intro = "深渊之上的断桥：桥面有缺口，缺口旁只有一条窄板可以小心绕行。\n失足坠入虚无不是终点——你会被送回桥头，再走一次。\n\n桥的尽头，【无限追问者】盘踞在决战平台上：\n它的追问弹幕直击意志，还会在你脚下崩开「意义崩桥」（红圈快躲）。\n\n破局关键：平台一角有一座**行动答台**——\n走近使用，「这个问题，我用做来回答」，它当场语塞【大破绽】。\n击败【首领·无限追问者】：用行动回答，而不是用答案行动。",
                victory = "追问者坠入它自己挖出的深渊，断桥两端亮起了灯。\n【哲学与行动线 · 完成】思想不是为了困住你，\n而是为了帮助你更清醒地行动——想不通的，先做一步再想。\n\n桥那头的建筑挂着一块牌子：「失败展览馆」。\n【终章 · 旧我与新我线】开启：不是杀死旧我，而是整合旧我。\n下一站：失败展览馆（决战平台北侧的门）。"
            },

            // ================= 第七章 · 旧我与新我线 =================
            new ChapterInfo
            {
                actIndex = 7, zoneIndex = 22,
                enemyType = EnemyType.PastJudge, enemyTier = EnemyTier.Chief,
            ...
            new ChapterInfo
            {
                actIndex = 7, zoneIndex = 23,
                enemyType = EnemyType.OldVoiceRepeater, enemyTier = EnemyTier.Chief,
                enemyId = "enemy_old_voice_repeater",
                title = "旧我线 其二 · 意志塔",
                intro = "一座三层递升的高塔：塔壁上刻满旧话——\n「你不行」「你总是这样」「别人都比你强」。\n每登一层，旧话就淡一分。\n\n塔顶站着【旧声音复读机】：它不生产否定，只是复读——\n复读了这么多年，你几乎以为那是自己的声音。\n沿坡道登塔，击败【首领·旧声音复读机】：旧话可以听见，但不必再照办。",
                victory = "复读机哑了。塔顶很安静——安静得能听见你自己的声音。\n那些话是别人说的、过去说的；现在轮到你说了。\n\n塔下的路通向最后一站：旧事回声馆。\n在那里，旧我在等你——不是等你杀死它，是等你带它回家。\n下一站：旧事回声馆（塔侧的门，或「传送」面板直达）。"
            },
            new ChapterInfo
            {
                ...
                victory = "旧我化为影子护卫，站到了你身后。\n「你曾经保护过我，但现在我要继续往前。」\n\n过去发生过，但不是你的全部；失败是事实，不是身份。\n\n可还有一件事没有处理完——前七章的胜利形态是「我做到了」「我守住了」「我看清了」。\n有一类处境不属于这三句里的任何一句：把柄在别人手里，而且指控成立。\n【第八章 · 羞耻与污名线】开启：事实可以成立，判词不能终审。\n下一站：欠条长廊 · 未播出的广播室（「传送」面板可直达）。",
