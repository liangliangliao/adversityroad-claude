...
namespace AdversityRoad.UI
{
    ...
    public class MovesPanel : MonoBehaviour
    {
        ...
        const string ReadAttackText =
            ...
            "\n" +
            "◤ 闪避本身的规则 ◢\n" +
            "  · 翻滚全程 0.30~0.42 秒，其中前 72% 无敌——滚动主体是打不到你的，\n" +
            "    只有最后收势的一小段能被打中。「读对了却还是被打到」不该发生。\n" +
            "  · 收势可被【攻击 / 跳 / 再次翻滚】立刻打断：闪完能马上还手，不用干等。\n" +
            "  · 在敌人判定框开启的瞬间翻滚＝完美闪避：时缓 + 意势+1 + 下一击必暴击，\n" +
            "    并且【强制打断攻击者】——这是固定规则，不是概率。\n" +
            "  · 格挡同理：出手瞬间按挡＝完美招架，零伤害 + 强制打断对方。\n" +
            "  · 体力见底会挡不住（有明确提示）；危险攻击（「危」）无论体力多少都挡不住。\n" +
            "\n" +
            "◤ 玩家侧的保护 ◢\n" +
