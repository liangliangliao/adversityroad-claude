...
namespace AdversityRoad.UI
{
    ...
    public class SafeHousePanel : MonoBehaviour
    {
        ...
        public static SafeHousePanel Create(Transform canvas, ReflectionPanel reflection,
            ...
            LevelSelectPanel levelSelect, MissionBoardPanel missionBoard)
        {
        ...
        {
            _panel = UiUtil.MakePanel(canvas, "SafeHousePanel", new Vector2(760, 1030),
            ...
            MakeEntry("成长 · 技能树五条路线", 1, () => Open(_growth != null ? (System.Action)_growth.Toggle : null));
            ...
            MakeEntry("目标 · 钉下今日唯一目标", 6, () => Open(_missionBoard != null ? (System.Action)_missionBoard.Toggle : null));
        ...
        void MakeEntry(string label, int index, UnityEngine.Events.UnityAction onClick)
        {
            UiUtil.MakeButton(_panel.transform, label, new Vector2(0.5f, 1f),
                new Vector2(0, -190 - index * 106), new Vector2(620, 90),
                new Color(0.2f, 0.24f, 0.32f, 0.96f), onClick, 26);
        }
